...
import { Card, Descriptions, Avatar, Button, Input, message } from "antd";
import { SERVER_IP, ENV } from "../../../utils/constants";
...
export const Profile = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      const id_user = user.id;
      const response = await UserController.updateUser(id_user, {
  ...
  const handleUpdatePhoto = async () => {
    ...
    try {
      ...
      console.log(
        "Respuesta del backend tras actualizar la foto:",
        updatedUser
      );
      setUserPhoto(updatedUser.data.photo_path);
      setNewPhoto(null);
      ...
      {loading ? (
        ...
        <>
          ...
          <Descriptions bordered column={1}>
            ...
            <Descriptions.Item label="RH y Grupo Sanguíneo">
              {userInfo.rhgb}
            </Descriptions.Item>
